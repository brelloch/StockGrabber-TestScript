...
my @stocks = ("ADBE","AMT","BAH","BRO","CDNS","CLX","CMG","CPRT","DG","DOCU","DXCM","FICO","FTNT","GMAB","HD","IDXX","ISRG","KEYS","KLAC","LDOS","LULU","MA","MSFT","NOW","NVDA","PGR","PYPL","QDEL","RMD","SPGI","TDY","TEAM","UI","V","VEEV","VIPS","VRSK","ZM","ZTS");
