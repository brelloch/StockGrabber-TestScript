...
my @stocks = ("ABR","AMGN","ARES","ARLP","BSM","CALM","CE","CHRD","CMC","CTRA","CVI","DVN","EOG","FANG","FAST","FNF","GIC","GLP","GNK","GNTY","HESM","HIG","LMT","NEM","NSA","NSP","NUE","OMF","RM","RS","SBR","SJT","STLD","STR","TXN","UNP","VNOM","VVV","WD");
